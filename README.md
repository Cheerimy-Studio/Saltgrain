...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=513"><img src="assets/ledger-light.svg?v=513" width="100%" alt="Saltgrain ledger, height 513"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `513` |
| **链尖** | `5502d0cfa3b51a0259835e76ae1707d8408ffc55847d1884e1c94dd4c953df2d` |
| **难度** | `139,828,912,426,872,061,952.0`  (bits `0x16021c5c`) |
| **累计工作量** | `1,075,222,438,964,078,567,908,775,794` 次预期尝试 |
| **已发行** | `25700.00000000 SALT`，分布在 `514` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `316` | `61.5%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `123` | `23.9%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `6150.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 513 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
