...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=524"><img src="assets/ledger-light.svg?v=524" width="100%" alt="Saltgrain ledger, height 524"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `524` |
| **链尖** | `b34c38acbe96cd945ae958ed0575e7fa7b6d53c9e023fdf14b24ab809aa9cc52` |
| **难度** | `139,828,912,426,872,061,952.0`  (bits `0x16021c5c`) |
| **累计工作量** | `2,688,056,097,410,196,419,623,633,989` 次预期尝试 |
| **已发行** | `26250.00000000 SALT`，分布在 `525` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `316` | `60.2%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `134` | `25.5%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `6700.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 524 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
