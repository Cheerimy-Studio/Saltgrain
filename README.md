...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=399"><img src="assets/ledger-light.svg?v=399" width="100%" alt="Saltgrain ledger, height 399"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `399` |
| **链尖** | `2356b6419b7915ea2ed0c23b93dbf1e7ee28d2d6751e25bd135203c0d8aa9121` |
| **难度** | `2,133,619,879,560,425.8`  (bits `0x18021c5c`) |
| **累计工作量** | `47,728,268,775,039,097,796,608` 次预期尝试 |
| **已发行** | `20000.00000000 SALT`，分布在 `400` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `310` | `77.5%` |
| [@Cheerimy-Studio](https://github.com/Cheerimy-Studio) | `36` | `9.0%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `35` | `8.8%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `1750.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 399 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
