...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=525"><img src="assets/ledger-light.svg?v=525" width="100%" alt="Saltgrain ledger, height 525"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `525` |
| **链尖** | `7516768ff1f888643744c0385a34fb89e662db5f261187fae81e8393178efbee` |
| **难度** | `139,828,912,426,872,061,952.0`  (bits `0x16021c5c`) |
| **累计工作量** | `2,834,677,339,087,116,224,324,984,734` 次预期尝试 |
| **已发行** | `26300.00000000 SALT`，分布在 `526` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `316` | `60.1%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `135` | `25.7%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `6750.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 525 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
