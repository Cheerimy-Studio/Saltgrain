...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1190"><img src="assets/ledger-light.svg?v=1190" width="100%" alt="Saltgrain ledger, height 1190"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1190` |
| **链尖** | `bc9adc24fdcc41a089c5f8c9add3ac1682793be421fcf7f55d0021b007155641` |
| **难度** | `2,635,562,265,121,943,931,941,175,810,152,203,371,321,229,312.0`  (bits `0x0b22a880`) |
| **累计工作量** | `34,084,243,831,787,591,026,593,240,754,596,194,090,440,741,512,258,296` 次预期尝试 |
| **已发行** | `59550.00000000 SALT`，分布在 `1191` 个未花费输出上 |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1190 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
