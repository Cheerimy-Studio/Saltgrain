...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1698"><img src="assets/ledger-light.svg?v=1698" width="100%" alt="Saltgrain ledger, height 1698"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1698` |
| **链尖** | `00c8467301cbee1cf95219ed757d6cb9df30e58af01b2643621e1889d6e86032` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,446,661,650,838,554` 次预期尝试 |
| **已发行** | `84950.00000000 SALT`，分布在 `1699` 个未花费输出上 |
...
| [@szfzmzx](https://github.com/szfzmzx) | `44` | `2.6%` |
...
| [@szfzmzx](https://github.com/szfzmzx) | `salt1q0epfdhc82cnw77h68g8w8us4tmylexkq6s9fsd` | `2200.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1698 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
