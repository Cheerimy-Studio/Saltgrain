...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=521"><img src="assets/ledger-light.svg?v=521" width="100%" alt="Saltgrain ledger, height 521"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `521` |
| **链尖** | `972f1292db85cd0c3762c593dfd54cecb83f805a7ba2bbf2881a0a0bd377181e` |
| **难度** | `139,828,912,426,872,061,952.0`  (bits `0x16021c5c`) |
| **累计工作量** | `2,248,192,372,379,437,005,519,581,754` 次预期尝试 |
| **已发行** | `26100.00000000 SALT`，分布在 `522` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `316` | `60.5%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `131` | `25.1%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `6550.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 521 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
