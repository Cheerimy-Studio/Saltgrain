...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=407"><img src="assets/ledger-light.svg?v=407" width="100%" alt="Saltgrain ledger, height 407"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `407` |
| **链尖** | `da329135128af89400b1bfb7805cac9a769367bddafc7c8f95b7dcefb0d8ce24` |
| **难度** | `8,534,479,518,241,703.0`  (bits `0x18008717`) |
| **累计工作量** | `119,320,671,937,597,596,185,936` 次预期尝试 |
| **已发行** | `20400.00000000 SALT`，分布在 `408` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `310` | `76.0%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `43` | `10.5%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `2150.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 407 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
