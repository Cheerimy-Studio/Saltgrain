...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=402"><img src="assets/ledger-light.svg?v=402" width="100%" alt="Saltgrain ledger, height 402"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `402` |
| **链尖** | `81ca1e3ec3035d4cafc2b68ff13bee8eed84e735a7b168f1de0987ea3e85050d` |
| **难度** | `8,534,479,518,241,703.0`  (bits `0x18008717`) |
| **累计工作量** | `74,575,419,960,998,534,692,606` 次预期尝试 |
| **已发行** | `20150.00000000 SALT`，分布在 `403` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `310` | `76.9%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `38` | `9.4%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `1900.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 402 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
