...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2235"><img src="assets/ledger-light.svg?v=2235" width="100%" alt="Saltgrain ledger, height 2235"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `2235` |
| **链尖** | `d33866d8ead832eb1bafd7f211ed7b326936dbafa6b927153c3b404654baf764` |
| **难度** | `1,383.8`  (bits `0x1d02f5c6`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,448,285,644,577,952` 次预期尝试 |
| **已发行** | `111800.00000000 SALT`，分布在 `2236` 个未花费输出上 |
...
| [@sxxso](https://github.com/sxxso) | `375` | `16.8%` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 2235 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
