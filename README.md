...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1697"><img src="assets/ledger-light.svg?v=1697" width="100%" alt="Saltgrain ledger, height 1697"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1697` |
| **链尖** | `3044e0f6cc52931eb1b2758efd8905eeeae107459531e97d810f3cf1cdc29d97` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,446,658,505,093,492` 次预期尝试 |
| **已发行** | `84900.00000000 SALT`，分布在 `1698` 个未花费输出上 |
...
| [@szfzmzx](https://github.com/szfzmzx) | `43` | `2.5%` |
...
| [@szfzmzx](https://github.com/szfzmzx) | `salt1q0epfdhc82cnw77h68g8w8us4tmylexkq6s9fsd` | `2150.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1697 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
