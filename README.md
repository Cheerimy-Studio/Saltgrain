...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1548"><img src="assets/ledger-light.svg?v=1548" width="100%" alt="Saltgrain ledger, height 1548"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1548` |
| **链尖** | `e62c8fcd6d541b03602b2fbd42697d3739964a7b5e9bd5069d91c83b4ee42ac2` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,446,189,789,079,254` 次预期尝试 |
| **已发行** | `77450.00000000 SALT`，分布在 `1549` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@Heartcoolman](https://github.com/Heartcoolman) | `609` | `39.3%` |
...
| 持有者 | 地址 | 余额 |
|---|---|--:|
| [@Heartcoolman](https://github.com/Heartcoolman) | `salt1qvhmjvm7mrczey63h7yxcpfdr3dj93w638t77p2` | `30450.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1548 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
