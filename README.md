...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=408"><img src="assets/ledger-light.svg?v=408" width="100%" alt="Saltgrain ledger, height 408"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `408` |
| **链尖** | `f627895f389aa30281729a7df4cfb194b10d83dadb5120cf8878b44b26229938` |
| **难度** | `8,534,479,518,241,703.0`  (bits `0x18008717`) |
| **累计工作量** | `128,269,722,332,917,408,484,602` 次预期尝试 |
| **已发行** | `20450.00000000 SALT`，分布在 `409` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `310` | `75.8%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `44` | `10.8%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `2200.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 408 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
