...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2606"><img src="assets/ledger-light.svg?v=2606" width="100%" alt="Saltgrain ledger, height 2606"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `2606` |
| **链尖** | `5e7826187c2b415584e3e379af6233fb9adb656b8582eeaeb6cbf5ac091d0dbb` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,449,401,685,032,802` 次预期尝试 |
| **已发行** | `130350.00000000 SALT`，分布在 `2607` 个未花费输出上 |
...
| [@ptcy03](https://github.com/ptcy03) | `141` | `5.4%` |
...
| _未认领_ | `salt1q728yr9vqc7vcjd9kpfelgsphuz56fyxkvp2jf5` | `7050.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 2606 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
