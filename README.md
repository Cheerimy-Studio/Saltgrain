...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1970"><img src="assets/ledger-light.svg?v=1970" width="100%" alt="Saltgrain ledger, height 1970"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1970` |
| **链尖** | `bf246d224e0fdeb9dd34d9e5e36f099d32b319777d03f4546ddd3531b69a7676` |
| **难度** | `1,338.4`  (bits `0x1d030f7a`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,447,512,066,386,024` 次预期尝试 |
| **已发行** | `98550.00000000 SALT`，分布在 `1971` 个未花费输出上 |
...
| [@szfzmzx](https://github.com/szfzmzx) | `86` | `4.4%` |
...
| [@szfzmzx](https://github.com/szfzmzx) | `salt1q0epfdhc82cnw77h68g8w8us4tmylexkq6s9fsd` | `4300.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1970 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
