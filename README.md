...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=520"><img src="assets/ledger-light.svg?v=520" width="100%" alt="Saltgrain ledger, height 520"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `520` |
| **链尖** | `4286ed75108fd2031483c59467997e9966144fea377c20902251418e97b4f17b` |
| **难度** | `139,828,912,426,872,061,952.0`  (bits `0x16021c5c`) |
| **累计工作量** | `2,101,571,130,702,517,200,818,231,009` 次预期尝试 |
| **已发行** | `26050.00000000 SALT`，分布在 `521` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `316` | `60.7%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `130` | `25.0%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `6500.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 520 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
