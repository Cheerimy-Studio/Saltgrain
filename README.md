...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1702"><img src="assets/ledger-light.svg?v=1702" width="100%" alt="Saltgrain ledger, height 1702"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1702` |
| **链尖** | `964ca6cbea73b375a77d8831abe1152b63fecfc1af488b9534605e0955e2791b` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,446,674,233,818,802` 次预期尝试 |
| **已发行** | `85150.00000000 SALT`，分布在 `1703` 个未花费输出上 |
...
| [@szfzmzx](https://github.com/szfzmzx) | `48` | `2.8%` |
...
| [@szfzmzx](https://github.com/szfzmzx) | `salt1q0epfdhc82cnw77h68g8w8us4tmylexkq6s9fsd` | `2400.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1702 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
