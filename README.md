...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2004"><img src="assets/ledger-light.svg?v=2004" width="100%" alt="Saltgrain ledger, height 2004"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `2004` |
| **链尖** | `38531b9de11ebfab6812424d321eec9495b939aa7f4264253cfd80ed03d1da8f` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,447,579,314,688,566` 次预期尝试 |
| **已发行** | `100250.00000000 SALT`，分布在 `2005` 个未花费输出上 |
...
| [@sxxso](https://github.com/sxxso) | `307` | `15.3%` |
...
| [@sxxso](https://github.com/sxxso) | `salt1qf9e3eu3qeekvm7kgwyc7d8ylfk8llq7juwx5sq` | `15350.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 2004 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
