...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1103"><img src="assets/ledger-light.svg?v=1103" width="100%" alt="Saltgrain ledger, height 1103"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1103` |
| **链尖** | `52f9d8afcd772635e3f9299adf422c82d27abfeef57ac73dbebb6f10e93a973b` |
| **难度** | `643,447,818,633,287,092,759,076,125,525,440,276,201,472.0`  (bits `0x0d022a88`) |
| **累计工作量** | `14,393,684,050,585,976,023,058,011,887,164,203,853,366,577,482,576` 次预期尝试 |
| **已发行** | `55200.00000000 SALT`，分布在 `1104` 个未花费输出上 |
...
| [@Heartcoolman](https://github.com/Heartcoolman) | `290` | `26.3%` |
...
| [@Heartcoolman](https://github.com/Heartcoolman) | `salt1qvhmjvm7mrczey63h7yxcpfdr3dj93w638t77p2` | `14500.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1103 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
