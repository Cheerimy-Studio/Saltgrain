...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=318"><img src="assets/ledger-light.svg?v=318" width="100%" alt="Saltgrain ledger, height 318"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `318` |
| **链尖** | `e5e62687a4afa254a52754b2298fdebc3a43d45e604b6274c09119e3fa16cf90` |
| **难度** | `2,083,613,163,633.2`  (bits `0x19087170`) |
| **累计工作量** | `44,424,810,719,053,016,783` 次预期尝试 |
| **已发行** | `15950.00000000 SALT`，分布在 `319` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `269` | `84.3%` |
...
| 持有者 | 地址 | 余额 |
|---|---|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `salt1q5umsmm2dcf3dhgvpw6n6xd2zu7xtnfswmgypew` | `13450.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 318 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
