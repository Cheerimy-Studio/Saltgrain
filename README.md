...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=519"><img src="assets/ledger-light.svg?v=519" width="100%" alt="Saltgrain ledger, height 519"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `519` |
| **链尖** | `e8e189e99298086146f856f2ec4e8596e843b4367fe8063689c9128de7e6c8a4` |
| **难度** | `139,828,912,426,872,061,952.0`  (bits `0x16021c5c`) |
| **累计工作量** | `1,954,949,889,025,597,396,116,880,264` 次预期尝试 |
| **已发行** | `26000.00000000 SALT`，分布在 `520` 个未花费输出上 |
...
| `517` | `35572e07c2b28e3ee44f…` | [@yannicksong0106](https://github.com/yannicksong0106) | `something for nothing 1000%融合` | `1` | `50.00000000` | 2026-09-13 10:11 UTC |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@StevenQinDev](https://github.com/StevenQinDev) | `316` | `60.8%` |
| [@yannicksong0106](https://github.com/yannicksong0106) | `129` | `24.8%` |
| [@sxxso](https://github.com/sxxso) | `39` | `7.5%` |
| [@Cheerimy-Studio](https://github.com/Cheerimy-Studio) | `36` | `6.9%` |
...
| _未认领_ | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `6450.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 519 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
