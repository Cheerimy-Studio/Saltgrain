...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2601"><img src="assets/ledger-light.svg?v=2601" width="100%" alt="Saltgrain ledger, height 2601"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `2601` |
| **链尖** | `f9799f45399caa392037d3f45bbfa5ee81f4eb25e3f0195219b25377aee66e8b` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,449,385,956,307,492` 次预期尝试 |
| **已发行** | `130100.00000000 SALT`，分布在 `2602` 个未花费输出上 |
...
| [@ptcy03](https://github.com/ptcy03) | `136` | `5.2%` |
...
| _未认领_ | `salt1q728yr9vqc7vcjd9kpfelgsphuz56fyxkvp2jf5` | `6800.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 2601 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
