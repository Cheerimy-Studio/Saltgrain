...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=612"><img src="assets/ledger-light.svg?v=612" width="100%" alt="Saltgrain ledger, height 612"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `612` |
| **链尖** | `24d0709c1c3937a1bc139ca7d5f3d9d290511c0edfe04cfdca9014d0e82a2653` |
| **难度** | `572,739,225,300,467,965,755,392.0`  (bits `0x1421c5c0`) |
| **累计工作量** | `6,205,792,927,722,856,373,919,669,611,445` 次预期尝试 |
| **已发行** | `30650.00000000 SALT`，分布在 `613` 个未花费输出上 |
...
| [@yannicksong0106](https://github.com/yannicksong0106) | `222` | `36.2%` |
...
| [@yannicksong0106](https://github.com/yannicksong0106) | `salt1q0rvj5waf6esv8rktd9m7kw2qfncv2d0h4u8002` | `11100.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 612 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
