...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2236"><img src="assets/ledger-light.svg?v=2236" width="100%" alt="Saltgrain ledger, height 2236"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `2236` |
| **链尖** | `b295ab8503891e33b1a74297894db158ab060ad51afd035b6ae386a6812a5849` |
| **难度** | `1,383.8`  (bits `0x1d02f5c6`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,448,287,095,554,686` 次预期尝试 |
| **已发行** | `111850.00000000 SALT`，分布在 `2237` 个未花费输出上 |
...
| [@sxxso](https://github.com/sxxso) | `376` | `16.8%` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 2236 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
