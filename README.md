...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2607"><img src="assets/ledger-light.svg?v=2607" width="100%" alt="Saltgrain ledger, height 2607"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `2607` |
| **链尖** | `694a3db1fbdef7b639bc008992efeead0d799028d17cc148f2da8eb33fc1b805` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,449,404,830,777,864` 次预期尝试 |
| **已发行** | `130400.00000000 SALT`，分布在 `2608` 个未花费输出上 |
...
| [@ptcy03](https://github.com/ptcy03) | `142` | `5.4%` |
...
| _未认领_ | `salt1q728yr9vqc7vcjd9kpfelgsphuz56fyxkvp2jf5` | `7100.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 2607 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
