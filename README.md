...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1102"><img src="assets/ledger-light.svg?v=1102" width="100%" alt="Saltgrain ledger, height 1102"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1102` |
| **链尖** | `01a7d08987aec7226adcc185690abd42f55e61ffc38a1cb9c8b292b0ee6fc29d` |
| **难度** | `643,447,818,633,287,092,759,076,125,525,440,276,201,472.0`  (bits `0x0d022a88`) |
| **累计工作量** | `13,718,980,110,714,758,400,858,824,163,887,673,690,236,846,711,997` 次预期尝试 |
| **已发行** | `55150.00000000 SALT`，分布在 `1103` 个未花费输出上 |
...
| [@Heartcoolman](https://github.com/Heartcoolman) | `289` | `26.2%` |
...
| [@Heartcoolman](https://github.com/Heartcoolman) | `salt1qvhmjvm7mrczey63h7yxcpfdr3dj93w638t77p2` | `14450.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1102 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
