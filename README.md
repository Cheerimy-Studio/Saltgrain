...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=2602"><img src="assets/ledger-light.svg?v=2602" width="100%" alt="Saltgrain ledger, height 2602"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `2602` |
| **链尖** | `ac52568fb27fda3fa3a3c1c989d983b01f4c753857d2af89f7ea7394bc01c4f4` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,449,389,102,052,554` 次预期尝试 |
| **已发行** | `130150.00000000 SALT`，分布在 `2603` 个未花费输出上 |
...
| [@ptcy03](https://github.com/ptcy03) | `137` | `5.3%` |
...
| _未认领_ | `salt1q728yr9vqc7vcjd9kpfelgsphuz56fyxkvp2jf5` | `6850.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 2602 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
