...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1973"><img src="assets/ledger-light.svg?v=1973" width="100%" alt="Saltgrain ledger, height 1973"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1973` |
| **链尖** | `5dd25d3db1d7d7f783eecf2d9e992443474ef33020d523df56144010abe635a2` |
| **难度** | `1,338.4`  (bits `0x1d030f7a`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,447,516,276,511,816` 次预期尝试 |
| **已发行** | `98700.00000000 SALT`，分布在 `1974` 个未花费输出上 |
...
| [@szfzmzx](https://github.com/szfzmzx) | `89` | `4.5%` |
...
| [@szfzmzx](https://github.com/szfzmzx) | `salt1q0epfdhc82cnw77h68g8w8us4tmylexkq6s9fsd` | `4450.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1973 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
