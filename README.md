...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/ledger-dark.svg?v=1547"><img src="assets/ledger-light.svg?v=1547" width="100%" alt="Saltgrain ledger, height 1547"></picture>

| 项目 | 数值 |
|---|---|
| **高度** | `1547` |
| **链尖** | `ead32e1dcae33a38f823cafc2dd68186bd72bbdd3ec4d0d9bc430159b2bf586d` |
| **难度** | `3,000.0`  (bits `0x1d015d86`) |
| **累计工作量** | `13,167,251,119,487,426,843,568,816,863,240,066,240,727,289,815,584,446,186,643,334,192` 次预期尝试 |
| **已发行** | `77400.00000000 SALT`，分布在 `1548` 个未花费输出上 |
...
| 采盐者 | 盐块数 | 占比 |
|---|--:|--:|
| [@Heartcoolman](https://github.com/Heartcoolman) | `608` | `39.3%` |
...
| 持有者 | 地址 | 余额 |
|---|---|--:|
| [@Heartcoolman](https://github.com/Heartcoolman) | `salt1qvhmjvm7mrczey63h7yxcpfdr3dj93w638t77p2` | `30400.00000000 SALT` |
...
<sub>以上内容由 `chain/blocks.jsonl` 在高度 1547 自动生成，任何人可用 <code>python3 verify.py</code> 自行核验。</sub>
